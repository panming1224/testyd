...
class ERPProblemOrderCollector:
    ...
    def fetch_problem_orders(self, page_index: int = 1):
        ...
        try:
            ...
            print(f"响应内容: {response.text[:2000]}...")  # 只显示前2000字符
            print("================\n")
    ...
    def merge_files(self):
        ...
        try:
            ...
            # 使用ExcelMerger合并文件
            merger = ExcelMerger(str(source_dir), str(merged_dir))  # 添加folder_path和output_dir参数
            success = merger.merge_excel_files(str(merged_file))
